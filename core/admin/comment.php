...
if(!$plxAdmin->getCommentaires('/^'.plxUtils::nullbyteRemove($_GET['c']).'.xml$/',0,1)) {
...
<ul>
	<li><?php echo L_COMMENT_DATE_FIELD ?> : <?php echo plxDate::dateIsoToHum($plxAdmin->plxRecord_coms->f('date'),'#day #num_day #month #num_year(4) &agrave; #hour:#minute'); ?></li>
