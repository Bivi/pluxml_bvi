...
<form action="parametres_affichage.php" method="post" id="form_settings">
	<fieldset class="withlabel">
		...
		<?php plxUtils::printInput('bypage', $plxAdmin->aConf['bypage'], 'text', '2-2'); ?>
		<p class="field"><label for="id_bypage_archives"><?php echo L_CONFIG_VIEW_BYPAGE_ARCHIVES ?>&nbsp;:</label></p>
		<?php plxUtils::printInput('bypage_archives', $plxAdmin->aConf['bypage_archives'], 'text', '2-2'); ?>
		<p class="field"><label for="id_bypage_admin"><?php echo L_CONFIG_VIEW_BYPAGE_ADMIN ?>&nbsp;:</label></p>
		<?php plxUtils::printInput('bypage_admin', $plxAdmin->aConf['bypage_admin'], 'text', '2-2'); ?>
		...
		<?php plxUtils::printInput('bypage_admin_coms', $plxAdmin->aConf['bypage_admin_coms'], 'text', '2-2'); ?>
		<p class="field"><label><?php echo L_CONFIG_VIEW_IMAGES ?>&nbsp;:</label></p>
		<?php plxUtils::printInput('images_l', $plxAdmin->aConf['images_l'], 'text', '4-4'); ?>	 x
		<?php plxUtils::printInput('images_h', $plxAdmin->aConf['images_h'], 'text', '4-4'); ?>
		...
		<?php plxUtils::printInput('bypage_feed', $plxAdmin->aConf['bypage_feed'], 'text', '2-2'); ?>
