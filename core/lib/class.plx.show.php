...
class plxShow {
	 ...
	 * @param	select	critere de recherche: all, draft, published, n° categories séparés par un |
	 * @return	stdout
	 * @scope	global
	 * @author	Stephane F
	 **/
	 ...
	 * @param	echo			affiche le résultat à l'écran si à VRAI, sinon retourne le resultat
	 * @return	stdout
	 * @scope	global
	 * @author	Stephane F
	 **/
